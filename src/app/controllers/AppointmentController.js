...
import { startOfHour, parseISO, isBefore, format, subHours } from 'date-fns'; // Time lib
...
class AppointmentController {
  async index(req, res) {
    ...
    const appointments = await Appointment.findAll({
      ...
      order: ['date'],
      attributes: ['id', 'date', 'past', 'cancelable'], // Which attributes will send
      limit: 20,
      offset: (page - 1) * 20,
      include: [
        {
